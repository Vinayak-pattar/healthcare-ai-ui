...
export default function PatientDashboard() {
  ...
  <p className="text-slate-400 mt-2">
    Monitor your treatment journey and medical reports
  </p>
</div>
  ...
  View Full AI Analysis
      ...
      <div className="mt-12">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-5 flex justify-between items-center">
