...
export default function AIRecommendations() {
  ...
  const recommendations = patients
    ...
    .map((patient) => ({
      ...
      reason: `${patient.disease} shows ${patient.symptoms.join(", ")}. AI review recommends ${patient.aiSuggestions[0].toLowerCase()}.`,
    }));
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm text-slate-500">
            Patient-specific action items generated by the clinical AI engine.
          </p>
        </div>
      ...
      <div className="space-y-6">
        {recommendations.map((item, index) => {
          ...
          return (
            <div key={index} className="rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-slate-200">
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                ...
                <button
                  onClick={() => {
                    recordRecommendationDecision(patient.id, "accept");
                ...
                <button
                  onClick={() => {
                    recordRecommendationDecision(patient.id, "reject");
                    setDecisionRefresh((current) => current + 1);
                  }}
                  disabled={patientDecision?.action === "accepted" || patientDecision?.action === "rejected"}
                  className={`rounded-3xl px-6 py-3 text-sm font-semibold transition ${
