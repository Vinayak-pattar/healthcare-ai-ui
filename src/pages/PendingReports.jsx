...
export default function PendingReports() {
  ...
  const pendingPatients = patients.filter((patient) => patient.reports.length > 0);
      ...
      footer={
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-slate-200">
            ...
            <p className="mt-2 text-sm text-slate-600">{filteredPatients.length} patient entries match the current search.</p>
          </div>
          <div className="rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-slate-200">
